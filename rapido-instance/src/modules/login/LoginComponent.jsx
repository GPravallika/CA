...
export default class extends React.Component{
  ...
  handleGithubLogin() {
    window.location.href = apiObj.endPoint + 'login/github';
  }
  ...
  handleSubmit(event) {
    ...
    if (this.showFormErrors()) {
      let lgSerLoginRes = null;
      LoginService.login(this.state)
      .then((response) => {
        lgSerLoginRes = response.clone();
  ...
  /* Method to navigate to Reset Password */
  resetPassword() {
          ...
          <form className="col-sm-4 col-sm-offset-4 login-form" noValidate onSubmit={this.handleSubmit}>
            ...
            <div className="form-group">
              <input
                ...
                name="userId"
                ref="userId"
                placeholder="Email / User ID *" required/>
                <div className="error" id="userIdError" ></div>
            </div>
            <div className="form-group">
              <input
                type="password"
